                ...
                function fetchPrediction() {
                    ...
                    fetch(HISTORY_API_URL, {
                        ...
                        if (item) {
                            ...
                            if (lastPredictionPeriod && lastPredictionPeriod === apiPeriod) {
                                ...
                                if (lastPredictionValue !== "SKIP" && lastPredictionValue !== "PANIC") {
                                    if (isWin) {
                                        ...
                                        consecutiveLossCount = 0; // Reset loss count
                                    } else {
                                        ...
                                        if(consecutiveLossCount >= 4) { // টানা ৪ বার হারলে PANIC MODE!
                                            inPanicMode = true;
                                            panicCooldown = 3; // ৩ রাউন্ড স্কিপ করবে
                                        }
                                    }
                                } else {
                            ...
                            // 🚨 MANAGER TAKING ACTION (PANIC MODE COOLDOWN) 🚨
                            if (inPanicMode) {
                                panicCooldown--;
                                if (panicCooldown <= 0) {
                                    inPanicMode = false;
                ...
                function updatePrediction(type, accuracy, trend) {
                    ...
                    if(el) {
                        ...
                        if (type === "PANIC") {
                            ...
                            showToast("🚨 PANIC MODE! মার্কেট জঘন্য! পরবর্তী ৩ রাউন্ড স্কিপ করা হচ্ছে।", [{type: 'SKIP'}], true);
                        }
                        else if(type === "SKIP") {
