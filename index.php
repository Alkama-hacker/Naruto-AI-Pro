...
// 🎭 Emp 9: The 3-3 Mirror Pattern (A-A-A-B-B-B)
                    ...
                    if (nums[0] > nums[1] && nums[1] > nums[2]) {
                        ...
                        employees.push({pred: "BIG", acc: 90, trend: "PENDULUM SNAP"});
                    }
...
if (sizes[0] === sizes[2] && sizes[0] !== sizes[1]) { 
    employees.push({pred: sizes[0], acc: 96, trend: "SANDWICH TRAP"}); }
                    ...
                    fetch(HISTORY_API_URL, {
                        ...
                        if (item) {
                            ...
                            if (lastPredictionPeriod && lastPredictionPeriod === apiPeriod) {
                                ...
                                if (lastPredictionValue !== "SKIP" && lastPredictionValue !== "PANIC") {
                                    if (isWin) {
                                        ...
                                        consecutiveLossCount = 0; // ম্যানেজার লস কাউন্ট জিরো করে দিল
                                    } else {
                                        ...
                                        consecutiveLossCount++; // লস গুনছে
                                        if(consecutiveLossCount >= 4) { 
                                            // টানা ৪ বার হারলে PANIC MODE চালু!
                                            inPanicMode = true;
                                            panicCooldown = 3; // পরবর্তী ৩ রাউন্ড স্কিপ করবে
                                        }
                                    }
                                } else {
                            ...
                            if (inPanicMode) {
                                ...
                                // প্যানিক মোডে ৩ রাউন্ড জোর করে SKIP করাবে!
                ...
                function fallbackPrediction() {
                    ...
                    updatePrediction("SKIP", 00, "NETWORK ERR");
                }
